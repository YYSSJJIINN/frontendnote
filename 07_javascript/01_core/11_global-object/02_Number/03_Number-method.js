...
// 1. Number.isFinite : 인수로 전달 된 숫자값이 정상적인 유한수인지 검사하여 결과를 불리언으로 반환
...
// 2. Number.isInteger : 인수로 전달 된 숫자값이 정수인지 검사하여 결과를 불리언으로 반환
...
// 3. Number.isNaN : 인수로 전달 된 숫자값이 NaN인지 검사하여 결과를 불리언으로 반환
console.log(Number.isNaN(NaN));             // true
console.log(Number.isNaN(undefined));       // false
console.log(isNaN(undefined));              // 빌트인 전역함수 isNaN은 암묵적 타입변환을 한다
console.log('----------------------');

// 4. Number.isSafeInteger : 인수로 전달 된 숫자값이 안전한 정수인지 검사하여 결과를 불리언으로 반환
...
// 7. Number.prototype.toPrecision : 인수로 전달 받은 전체 자릿수까지 유효하도록 나머지 자릿수를 반올림하여 문자열로 반환
