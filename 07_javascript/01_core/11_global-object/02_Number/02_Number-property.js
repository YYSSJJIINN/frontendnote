...
// 2. Number.MIN_VALUE : 자바스크립트에서 표현할 수 있는 가장 작은 양수 값
console.log(Number.MIN_VALUE);
console.log(Number.MIN_VALUE > 0);          // 0보다 크다

// 3. Number.MAX_SAFE_INTEGER : 자바스크립트에서 안전하게 표현할 수 있는 가장 큰 정수 값
console.log(Number.MAX_SAFE_INTEGER);

// 4. Number.MIN_SAFE_INTEGER : 자바스크립트에서 안전하게 표현할 수 있는 가장 작은 정수 값
...
// 7. Number.NaN : 숫자가 아님을 나타내는 숫자값
console.log(Number.NaN);

// 8. Number.EPSILON : 부동 소수점으로 인해 발생하는 오차를 해결하기 위해 사용한다
