...
// 1. Math.abs : 인수로 전달된 숫자의 절대값을 반환
console.log(Math.abs(-10));                     // 10
console.log(Math.abs('-10'));                   // 10
console.log(Math.abs(''));                      // 0(Falsy)
...
// 3. Math.ceil : 인수로 전달된 숫자의 소수점 이하를 올림한 정수를 반환
...
// 4. Math.floor : 인수로 전달된 숫자의 소수점 이하를 내림한 정수를 반환
...
// 5. Math.sqrt : 인수로 전달된 숫자의 제곱근을 반환 : 스퀘어 루트
...
// 6. Math.random : 임의의 난수(0에서 1 미만의 실수) 반환
...
// 7. Math.pow : 첫번째 인수를 밑으로 두번째 인수를 지수로 거듭제곱한 결과 반환
...
// 8. Math.max : 전달받은 인수 중 가장 큰 수를 반환
